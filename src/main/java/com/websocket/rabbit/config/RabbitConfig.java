package com.websocket.rabbit.config;
...
public class RabbitConfig {
	...
	private static final String CHAT_EXHANGE_NAME = "chat.exchange";
	...
	public TopicExchange exchange() {
		return new TopicExchange(CHAT_EXHANGE_NAME);
	}
	...
	@Bean
	public com.fasterxml.jackson.databind.Module dateTimeMoudle() {
    ...
    public Jackson2JsonMessageConverter jsonMessageConverter() {
        ...
        objectMapper.registerModule(dateTimeMoudle());
